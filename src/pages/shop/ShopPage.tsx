            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex flex-col items-center">
                <div className="p-2">
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" className="text-primary">
                    <path
                      d="M11 1L21 6V16L11 21L1 16V6L11 1Z"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="p-2">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" className="text-gray-400">
                  ...
                  <rect x="12" y="3" width="7" height="7" stroke="currentColor" strokeWidth="2"/>
                  <rect x="3" y="12" width="7" height="7" stroke="currentColor" strokeWidth="2"/>
              ...
              {/* Wishlist */}
              <div className="p-2">
                <svg width="22" height="20" viewBox="0 0 22 20" fill="none" className="text-primary">
                  <path
              ...
              <div className="p-2">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" className="text-primary">
                  <path
                    d="M6 1L3 5V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H17C17.5304 21 18.0391 20.7893 18.4142 20.4142C18.7893 20.0391 19 19.5304 19 19V5L16 1H6Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              {/* Profile */}
              <div className="p-2">
                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" className="text-gray-400">
                  <path
                    d="M11 1C8.79086 1 7 2.79086 7 5C7 7.20914 8.79086 9 11 9C13.2091 9 15 7.20914 15 5C15 2.79086 13.2091 1 11 1Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M1 22V20C1 17.7909 2.79086 16 5 16H17C19.2091 16 21 17.7909 21 20V22"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
