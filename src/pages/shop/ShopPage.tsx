...
const ShopPage: React.FC = () => {
  ...
  const renderBottomNav = () => (
    <div className="fixed bottom-0 left-0 right-0 bg-white shadow-[0_-2px_4px_rgba(0,0,0,0.05)]">
      <div className="flex justify-around items-center h-16">
        {/* Home */}
        <div className="flex flex-col items-center cursor-pointer text-blue-600" onClick={() => navigate('/shop')}>
        ...
        {/* Cart */}
        <div className="flex flex-col items-center cursor-pointer text-gray-500 relative" onClick={() => navigate('/cart')}>
        ...
        {/* Orders */}
        <div className="flex flex-col items-center cursor-pointer text-gray-500" onClick={() => {/* TODO */}}>
